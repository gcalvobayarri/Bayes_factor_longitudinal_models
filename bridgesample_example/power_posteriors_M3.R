...
for (h in 1 : 5){
  ...
  write.table(app_evidence_power_posterior, 
              file = "./bridgesample_example/app_evidence_power_posterior_M3.txt", 
              sep = ' ',
...
time_pp_M3 <- end_time_M3 - start_time_M3

save(app_evidence_power_posterior_M3, time_pp_M3,
     file = "./bridgesample_example/app_evidence_power_posterior_M3.RData")
